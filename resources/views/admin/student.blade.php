                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            ...
                            <a href="" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('images/logo-light.png')}}" alt="" height="50 !important;">
                                </span>
                            </a>
                        </div>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="schools with tabs.html" class="nav-link" data-key="t-analytics">
                                            Schools </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="dashboard-crm.html" class="nav-link" data-key="t-crm"> Colleges </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="" class="nav-link" data-key="t-ecommerce"> Advance </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="teacher's list.html">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Student's List</h4>
                                </div><!-- end card header -->
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="customer_name">Ablore</td>
                                                        <td class="email">ablore@ablore.com</td>
                            ...
                            <div class="modal-content">
                                ...
                                <form>
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="customername-field" class="form-label">Student Name</label>
                                ...
                                <form>
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="customername-field" class="form-control" placeholder="Enter Class" required />
                                        </div>
