...
<body style="background-image:url(images/college/images/main\ bg.png); background-repeat: no-repeat;background-size:70%;">
    ...
    <img src="images/language/images/language_banner.jpg" class="img-fluid w-100" alt="">
        ...
        <div class="container-fluid my-5">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p class="pink-heading heading-in-mob">CrackerJack advantage</p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-5 d-flex justify-content-center">
                    <div class="col-md-12 col-8  text-center p-5 key-features-spacing grey-border hover-shadow">
                        <img src="images/language/images/icon 1.png" class="img-fluid mb-3" style="width:70px ;" alt="">
                        <p>Personal language trainer with flexible schedulin</p>
                    </div>
                </div>
                <div class="col-md-4 d-flex justify-content-center mb-5 ">
                    <div class="col-md-12 col-8 text-center key-features-spacing p-5 grey-border hover-shadow">
                        <img src="images/language/images/icon 2.png" class="img-fluid mb-3" style="width:70px ;" alt="">
                        <p>Live and interactive one to one sessions
                        </p>
                    </div>
                </div>
                <div class="col-md-4 d-flex justify-content-center mb-5 ">
                    <div class="col-md-12 col-8 text-center key-features-spacing p-5 grey-border hover-shadow">
                        <img src="images/language/images/icon 3.png" class="img-fluid mb-3" style="width:70px ;" alt="">
                        <p>Top language instructors from the country
                        </p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mt-3">
                    <p class="blue-heading heading-in-mob">Why</p>
                    <p class="pink-heading heading-in-mob">Be CrackerJack</p>
                </div>
            </div>
            ...
            <div class="accordion">
                <section class="accordion-content active">
                    <div class="head">
                        <p>Work or study abroad</p>
                    </div>
                    <img src="images/language/images/slide_b1.jpg" class="" alt="Image">
                </section>

                <section class="accordion-content">
                    <div class="head">
                        <p>Professional language trainers</p>
                    </div>
                    <img src="images/language/images/slide_b2.jpg" class="" alt="Image">
                </section>

                <section class="accordion-content">
                    <div class="head">
                        <p>Invaluable added skillset</p>
                    </div>
                    <img src="images/language/images/slide_b3.jpg" class="" alt="Image">
                </section>
                ...
                <section class="accordion-content">
                    ...
                    <img src="images/language/images/slide_b4.jpg" class="" alt="Image">
                </section>
            ...
            <div class="col-sm-12">
                <ul class="nav nav-pills justify-content-center">
                    <li class="nav-item"><a href="#subjects" data-bs-toggle="tab" class="active nav-link ">
                            <div class="button-style grey-border">European Languages</div>
                        </a></li>
